...
\begin{figure}
    ...
    \captionLink{https://www.youtube.com/watch?v=dQw4w9WgXcQ}{The link to the left is clickable, which is nice for theses where you want to link to videos or to other data that is hard to display as a figure in 2D.\label{fig:enter-label}}
\end{figure}
